package com.example.developmenttesting
...
import com.example.developmenttesting.databinding.ActivityMainBinding
import com.example.developmenttesting.ml.BestModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun outputGenerator(bitmap: Bitmap){
        ...
        val imgData = ByteBuffer.allocateDirect(150 * 150 * 3)
        ...
        for (i in 0 until 150) {
            for (j in 0 until 150) {
                ...
                imgData.putFloat((`val` shr 16 and 0xFF) * (1f / 1))
                imgData.putFloat((`val` shr 8 and 0xFF) * (1f / 1))
                imgData.putFloat((`val` and 0xFF) * (1f / 1))
            }
        }
        ...
        val highProbabilityOutput = classes[maxPos]
